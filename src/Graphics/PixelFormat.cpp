...
namespace Graphics
{
	...
	namespace PixelFormat
	{
		...
		void InitConvertionMatrix()
		{
			...
			// RGB16F <=> RGB32F
			s_pConvertionMatrix[E_PIXELFORMAT_RGB16_SFLOAT][E_PIXELFORMAT_RGB32_SFLOAT] = { Convert_RGB16F_To_RGB32F, 48 };
			s_pConvertionMatrix[E_PIXELFORMAT_RGB32_SFLOAT][E_PIXELFORMAT_RGB16_SFLOAT] = { Convert_RGB32F_To_RGB16F, -48 };

			// RGBA16F <=> RGBA32F
			s_pConvertionMatrix[E_PIXELFORMAT_RGBA16_SFLOAT][E_PIXELFORMAT_RGBA32_SFLOAT] = { Convert_RGBA16F_To_RGBA32F, 64 };
			s_pConvertionMatrix[E_PIXELFORMAT_RGBA32_SFLOAT][E_PIXELFORMAT_RGBA16_SFLOAT] = { Convert_RGBA32F_To_RGBA16F, -64 };

			// RGB32F <=> RGBA32F
			s_pConvertionMatrix[E_PIXELFORMAT_RGB32_SFLOAT][E_PIXELFORMAT_RGBA32_SFLOAT] = { Convert_RGB32F_To_RGBA32F, 32 };
			s_pConvertionMatrix[E_PIXELFORMAT_RGBA32_SFLOAT][E_PIXELFORMAT_RGB32_SFLOAT] = { Convert_RGBA32F_To_RGB32F, -32 };

			// RGBA16 => RGBA16F
			s_pConvertionMatrix[E_PIXELFORMAT_RGBA16_UNORM][E_PIXELFORMAT_RGBA16_SFLOAT] = { Convert_RGBA16_To_RGBA16F, -1 }; //Losing quality?

			// RGB16F <=> RGBA16F
			s_pConvertionMatrix[E_PIXELFORMAT_RGB16_SFLOAT][E_PIXELFORMAT_RGBA16_SFLOAT] = { Convert_RGB16F_To_RGBA16F, 16 };
			s_pConvertionMatrix[E_PIXELFORMAT_RGBA16_SFLOAT][E_PIXELFORMAT_RGB16_SFLOAT] = { Convert_RGBA16F_To_RGB16F, -16 };

			// RGBA8 <=> RGBA32F
			s_pConvertionMatrix[E_PIXELFORMAT_RGBA8_UNORM][E_PIXELFORMAT_RGBA32_SFLOAT] = { Convert_RGBA8_To_RGBA32F, 96 };
			s_pConvertionMatrix[E_PIXELFORMAT_RGBA32_SFLOAT][E_PIXELFORMAT_RGBA8_UNORM] = { Convert_RGBA32F_To_RGBA8, -96 };

			// RGB8 >=> RGB32F
			s_pConvertionMatrix[E_PIXELFORMAT_RGB8_UNORM][E_PIXELFORMAT_RGB32_SFLOAT] = { Convert_RGB8_To_RGB32F, 72 };
			s_pConvertionMatrix[E_PIXELFORMAT_RGB32_SFLOAT][E_PIXELFORMAT_RGB8_UNORM] = { Convert_RGB32F_To_RGB8, -72 };

			// R10G10B10A2 <=> RGBA32F
			s_pConvertionMatrix[E_PIXELFORMAT_R10G10B10A2_UNORM][E_PIXELFORMAT_RGBA32_SFLOAT] = { Convert_R10G10B10A2_To_RGBA32F, 96 };
			s_pConvertionMatrix[E_PIXELFORMAT_RGBA32_SFLOAT][E_PIXELFORMAT_R10G10B10A2_UNORM] = { Convert_RGBA32F_To_R10G10B10A2, -96 };

			// R9G9B9E5 => RGB32F
			s_pConvertionMatrix[E_PIXELFORMAT_R9G9B9E5_SHAREDEXP][E_PIXELFORMAT_RGB32_SFLOAT] = { Convert_R9G9B9E5_To_RGB32F, 64 };
